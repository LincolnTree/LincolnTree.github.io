...
setTimeout(function(){
   /* $('.heart').css('top','10%');
    ...
    $('.slide-6').css('background',"url('images/my/background1.png')");
    $('.slide-6').css('background-size',"100% 100%");
    $('.slide-7').css('background',"#ffffff");

	$('.slide-14').css('background',"#FF6600");
    $('.slide-14').css('background-size',"100% 100%");
	$('.slide-15').css('background',"#FF0000");
