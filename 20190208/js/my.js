...
setTimeout(function(){
   /* $('.heart').css('top','10%');
	...
	$('.slide-14').css('background',"url('images/my/bg7.jpg')");
    $('.slide-14').css('background-size',"100% 100%");
	$('.slide-15').css('background',"url('images/my/bg6.jpg')");
    $('.slide-15').css('background-size',"100% 100%");
	$('.slide-17').css('background',"url('images/my/qinqin2.jpg')");
    $('.slide-17').css('background-size',"100% 100%");
	
	$('.slide-19').css('background',"url('images/my/bg3.jpg')");
    $('.slide-19').css('background-size',"100% 100%");
	$('.slide-20').css('background',"url('images/my/bg8.jpg')");
    $('.slide-20').css('background-size',"100% 100%");
	$('.slide-22').css('background',"url('images/my/bg4.jpg')");
    $('.slide-22').css('background-size',"100% 100%");
	$('.slide-23').css('background',"url('images/my/timg.jpg')");
    $('.slide-23').css('background-size',"100% 100%");
},3000)
